                ...
                <form @submit.prevent="handleSubmit(onSubmit)">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-primary center-block" v-if="!editStatus.fetching">Update Product</button>
                                                <span class="btn btn-primary btn-disabled center-block" v-else>Updating...</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="block block-mode-loading-oneui align-items-center">
                                <div class="block-content block-content-full">
                                    <div class="form-group" v-if="!imgPreview">
...
export default {
    ...
    computed: {
        ...
        ...mapState({
            editStatus: state => state.product.doUpdate,
            detail: state => state.product.detail.data,
    ...
    methods: {
        ...
        onSubmit() {
            ...
            this.updateProduct({ data: dataToSend, id: this.detail.id })
        },
        ...mapActions({
    ...
    mounted() {
        ...
        this.desc = detail && detail.desc
        this.price = detail && detail.price > 0 ? this.formatIdr(detail.price) : 0
        this.stock = detail && detail.stock
        this.category = detail && detail.category
        this.imgPreview = `https://api.alfredo.my.id/product/thumbnail/${detail && detail.thumbnail}`
        this.errorThumbnail = ''
    }
}
</script>
